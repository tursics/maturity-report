...
Try the current version [here](https://demo.govdata.de/maturity-report/). [latest](https://tursics.github.io/maturity-report/)
...
7. Append the new year to the question tree in file `/assets/app.questiontree.js`.
